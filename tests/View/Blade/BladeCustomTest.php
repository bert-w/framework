...
<?php echo $__env->renderComponent(); ?>';
    ...
    public function testCustomIncludes()
    {
        ...
        $string = '@input';
        $expected = '<?php echo $__env->make(\'app.includes.input\', [], get_defined_vars())->render(); ?>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
    }
    ...
    public function testCustomIncludesWithData()
    {
        ...
        $expected = '<?php echo $__env->make(\'app.includes.input\', [\'type\' => \'email\'], get_defined_vars())->render(); ?>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
    }
    ...
    public function testCustomIncludesWithExistingDirective()
    {
        ...
        $string = '@foreach';
        $expected = '<?php echo $__env->make(\'app.includes.foreach\', [], get_defined_vars())->render(); ?>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
    }
